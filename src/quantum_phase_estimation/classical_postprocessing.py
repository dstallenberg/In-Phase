...
def remove_degeneracy(result, nancillas):
	...
	if result['histogram'] == OrderedDict():
		print("Recieved empty dict from QI, there is a syntax error in the qasm.")
		raise
...
def print_result(processed_tuple, desired_accuracy, nancillas):
	...
	return binary_fraction_to_decimal(processed_tuple, desired_accuracy, nancillas), 2**(-desired_accuracy+1), 
...
if __name__ == '__main__':
	...
	print_result(remove_degeneracy(result, 5), 3, 5)